...
const HomePage = () => {
  ...
  const getAllCategory = async () => {
    try {
      const { data } = await axios.get("https://https://ecommerce-9t2j.onrender.com/api/v1/category/get-category");
      if (data?.success) {
  ...
  const getAllProducts = async () => {
    try {
      setLoading(true);
      const { data } = await axios.get(`https://https://ecommerce-9t2j.onrender.com/api/v1/product/product-list/${page}`);
      setLoading(false);
  ...
  const getTotal = async () => {
    try {
      const { data } = await axios.get("https://https://ecommerce-9t2j.onrender.com/api/v1/product/product-count");
      setTotal(data?.total);
    } catch (error) {
      console.log(error);
    }
  ...
  const filterProduct = async () => {
    try {
      const { data } = await axios.post("https://https://ecommerce-9t2j.onrender.com/api/v1/product/product-filters", {
        checked,
        radio,
      });
      setProducts(data?.products);
  ...
  <div className="text-center flex flex-row mt-5 mb-5">
        <Link to={'https://ecommerce-gilt-alpha.vercel.app/category/mobiles'}>
         <img
        ...
        <Link to={'https://ecommerce-gilt-alpha.vercel.app/category/grocery'}>
          <img
        ...
        <Link to={'https://ecommerce-gilt-alpha.vercel.app/category/mens'}>
          <img
        ...
        <Link to={'https://ecommerce-gilt-alpha.vercel.app/category/electronics'}>
          <img
        ...
        <Link to={'https://ecommerce-gilt-alpha.vercel.app/category/appliances'}>
          <img
        ...
        <Link to={'https://ecommerce-gilt-alpha.vercel.app/category/homeandfurniture'}>
          <img
        ...
        <Link to={'https://ecommerce-gilt-alpha.vercel.app/category/kids'}>
          <img
          ...
          <div className="d-flex flex-wrap  ">
            {products?.map((p) => (
              <div className="card m-2" key={p._id}>
                <img
                  src={`https://https://ecommerce-9t2j.onrender.com/api/v1/product/product-photo/${p._id}`}
